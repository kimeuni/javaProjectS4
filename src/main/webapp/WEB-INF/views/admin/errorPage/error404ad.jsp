...
<jsp:include page="/WEB-INF/views/include/adminMenu.jsp" />
	<div id="admin-main-container">
		<div id="admin-main-right-content">
			<div id="top-menu-str">404에러 화면</div>
			<div id="admin-main-right-inner-content">
				<div id="admin-main-menu">
					<div id="admin-main-menu-str">404에러 화면 미리보기 <i class="fa-solid fa-image"></i><i class="fa-solid fa-pen"></i></div>
						<div class="text-center">
					    	<img src="${ctp}/data/images/404에러.png" height="100%" width="100%"/>
					    	<hr/>
